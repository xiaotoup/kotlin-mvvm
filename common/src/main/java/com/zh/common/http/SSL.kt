        ...
        init {
            try {
                ...
                if (socket != null) {
                    ...
                    val protocols: LinkedList<String> = LinkedList()
                    for (protocol in socket.getSupportedProtocols()) {
                    ...
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        val availableCiphers =
                            Arrays.asList<String>(*socket.getSupportedCipherSuites())
                        // take all allowed ciphers that are available and put them into preferredCiphers
                        val preferredCiphers: HashSet<String> =
                            HashSet<String>(allowedCiphers)
                     ...
                     * ciphers should be a server-side task */
                        ...
                        enabledCiphers.addAll(
                            HashSet(Arrays.asList<String>(*socket.getEnabledCipherSuites()) )
                        )
